...
from ocpp.v16.enums import Action, AuthorizationStatus, RemoteStartStopStatus,ReservationStatus,AvailabilityType,AvailabilityStatus,ConfigurationStatus,ClearCacheStatus
...
async def on_connect(websocket, path):
    ...
    try:
        ...
        # for start transaction
            ...
            await asyncio.gather(cp.start(),cp.clearcache())
